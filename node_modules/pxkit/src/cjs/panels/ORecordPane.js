...
import CjsScrollBar from "../components/ScrollBar";
import {getHMSTime} from "../../core/utils";
 ...
 */
export default class ORecordPane extends BaseClosePane {
    constructor() {
        super();
    }
    init(self) {
        ...
        this.scrollBarWidget  = new CjsScrollBar();
