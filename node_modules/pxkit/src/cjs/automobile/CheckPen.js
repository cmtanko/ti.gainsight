import {cjsObj} from "../../common/utils/util.cjs";
...
export default class CheckPen {
    ...
    onPenMove(event) {
        ...
        this.AnObj.parent.dispatchEvent(new cjsObj.MsgEvent('check_pen_move', {penName:target.name}, false, false));
    }
    ...
    checkHit(target) {
        ...
        const nowCheckPoint = CPointAry.find((item)=>{
            return cjsObj.HitTestObject(target, item) === true;
        });
        ...
        if(nowCheckPoint){
            ...
            if(this.oldCheckPoint){
                ...
                // this.AnObj.gotoAndStop(0);
                this.AnObj.parent.dispatchEvent(new cjsObj.MsgEvent('check_pen_nohit_point', {penName:target.name, pointName:''}, false, false));
            }
    ...
    setPenInfo(target, nCheckPoint) {
        ...
        this.AnObj.parent.dispatchEvent(new cjsObj.MsgEvent('check_pen_hited_point', {penName:target.name, pointName:nCheckPoint.name}, false, false));
    }
    /*重置拖动元件的位置等相关属性*/
    resetPenInfo(target) {
