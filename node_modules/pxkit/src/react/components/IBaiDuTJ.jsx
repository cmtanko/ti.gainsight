...
export default class IBaiDuTJ extends React.Component{
    static propTypes = {
        nITJUrl: PropTypes.string,
        nTJCore: PropTypes.string, //当前统计安装代码的核心内容
    };
    static defaultProps = {
        nITJUrl: '',
        nTJCore: "https://hm.baidu.com/hm.js?5fa65c52bd72727ce3d2c0ccdaa7187f",
    };
    constructor(props) {
        super(props);
        this.state = {
    ...
    addPageViewTrack(data) {
        ...
        _hmt.push(['_trackPageview', '/' + data.pagePath]);
    }


    install() {
        const hm = document.createElement("script");
        hm.src = this.props.nTJCore;  // "https://hm.baidu.com/hm.js?5fa65c52bd72727ce3d2c0ccdaa7187f"
    ...
    getResPv() {
        const str = 'getBaiDuTJResPagePv';
        $.ajax({
            url: this.props.nITJUrl + '/' + str,
            type:'get',
            // data:data,
            success:(data, status)=>{
    ...
    getSiteTotalPv() {
        const str = 'getBaiDuTJSiteTotalPv';
        $.ajax({
            url: this.props.nITJUrl + '/' + str,
            type:'get',
            // data:data,
    ...
    getSiteTodayPv() {
        const str = 'getBaiDuTJSiteTodayPv';
        $.ajax({
            url: this.props.nITJUrl + '/' + str,
            type:'get',
            // data:data,
